...
urlpatterns = [
    ...
    url(r'^api/v1/user/(?P<user_id>[a-zA-Z0-9]+)/$', views.get_user, name='get_user'),
    url(r'^api/v1/auth/(?P<auth>[a-zA-Z0-9]+)/$', views.get_user_id, name='get_user_id'),
    url(r'^api/v1/userid/(?P<user_id>[a-zA-Z0-9]+)/$', views.get_user_id_for_login, name='get_user_id_for_login'),
    ...
    url(r'^api/v1/update/user/(?P<user_id>[a-zA-Z0-9]+)/$', views.update_user, name='update_user'),
